...
@WebServlet("/member/register/step02/email-auth")
public class EmailAuthServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String title = "[댑스] 회원가입을 위한 인증코드입니다.";
		String content = "회원가입을 위한 인증코드는 <b><mark>"+code+"</mark></b>입니다.";
		mailsender.sendMail(email, title, content);
		request.setAttribute("url", "/member/register/step02/email-auth");
