...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/searchPwd.css">
    ...
    <div class="container">
        ...
        <main>
            ...
            <section id="wellcome-msg">
                    ...
                    <p>비밀번호를 찾기 위해 <span>아이디</span>와 가입이 사용한 <span>이메일</span>을 입력해주세요.</p>
            </section>
            <form action="/member/search-pwd" method="POST">
