...
var emailAuth = function(){
    ...
    let openWin = window.open("/member/mypage/modify/email-auth?email="+email, "Child", "width=400, height=300, top=200, left=450, toolbar=no, location=no, status=no, memubar=no, resizable=no");
